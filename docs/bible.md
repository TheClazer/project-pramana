...
- **The DCT watermark survives most compression, not all editing.** Heavy filtering, crops below 50%, or deliberate frequency-domain attacks can destroy it. The watermark is defense-in-depth, not unbreakable. Combined with the EXIF manifest, removing both leaves forensic traces.
